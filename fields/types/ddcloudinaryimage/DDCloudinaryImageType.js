...
/**
 * DDCloudinaryImage FieldType Constructor
 * @extends Field
 * @api public
 */
...
function ddcloudinaryimage(list, path, options) {
  //console.log("ddcloudinaryimage list", list);
	...
	ddcloudinaryimage.super_.call(this, list, path, options);
...
util.inherits(ddcloudinaryimage, super_);
...
ddcloudinaryimage.prototype.addToSchema = function() {
...
ddcloudinaryimage.prototype.format = function(item) {
...
ddcloudinaryimage.prototype.isModified = function(item) {
...
ddcloudinaryimage.prototype.validateInput = function(data) {//eslint-disable-line no-unused-vars
...
ddcloudinaryimage.prototype.getRequestHandler = function(item, req, paths, callback) {
...
ddcloudinaryimage.prototype.handleRequest = function(item, req, paths, callback) {
...
exports = module.exports = ddcloudinaryimage;
